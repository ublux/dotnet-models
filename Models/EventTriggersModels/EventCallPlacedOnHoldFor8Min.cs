...
public partial class EventCallPlacedOnHoldFor8Min
{
    ...
    /// </summary>
    public override EventCallPlacedOnHoldFor8Min BuildRandomFakeObject()
    {
        ...
        var f = new Faker<EventCallPlacedOnHoldFor8Min>()
        ...
        EventCallPlacedOnHoldFor8Min obj = f.Generate();
