...
public partial class EventExtensionTookToLongerThan1MinToBeAnswered
{
    /// <summary>
    ...
    /// </summary>
    public override EventExtensionTookToLongerThan1MinToBeAnswered BuildRandomFakeObject()
    {
        ...
        var f = new Faker<EventExtensionTookToLongerThan1MinToBeAnswered>()
        ...
        EventExtensionTookToLongerThan1MinToBeAnswered obj = f.Generate();
