...
public class CallErrors
{
    ...
    public List<string> ErrorsCall { get; set; } = new();
    ...
    [AllowUpdate(false)]
    [SwaggerSchema(ReadOnly = true)]
    public List<string> ErrorsRecording { get; set; } = new();
    ...
    [AllowUpdate(false)]
    [SwaggerSchema(ReadOnly = true)]
    public List<string> ErrorsAiTranscription { get; set; } = new();
    ...
    [AllowUpdate(false)]
    [SwaggerSchema(ReadOnly = true)]
    public List<string> ErrorsAiAnalysis { get; set; } = new();
}
