...
namespace Ublux.Communications.Models.Documents
{
    ...
    public partial class VoipProvider
    {
        ...
        public static BuiltId BuildId(VoipCompany voipCompany, UbluxPartner ubluxPartner, CountryIsoCode countryIsoCode) => new BuiltId($"{DocumentPrefix}.{voipCompany}-{ubluxPartner}-{countryIsoCode}");
    }
